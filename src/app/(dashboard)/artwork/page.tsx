                    ...
                    <div className="flex-1 overflow-y-auto pr-2 custom-scrollbar relative z-10">
                        <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 pb-6">
                            ...
                            <div className="border-2 border-dashed border-black/15 dark:border-white/15 rounded-[2rem] p-8 flex flex-col items-center justify-center text-center hover:bg-black/[0.02] dark:hover:bg-white/[0.02] transition-colors relative overflow-hidden group">
                                ...
                                <h3 className="font-bold text-lg mb-2">Add Artwork Location</h3>
                                <p className="text-sm font-medium text-black/50 dark:text-white/50 mb-6 max-w-[200px]">Drag and drop manual Photoshop mockups here.</p>
                                <div className="flex flex-col w-full gap-3 px-4">
                                    <button className="py-2.5 rounded-xl bg-black/5 dark:bg-white/10 text-sm font-bold hover:bg-black/10 dark:hover:bg-white/20 transition-colors">
                                        Upload File
                                    </button>
